#given input molucule, the machine will predict its solubility using logs value
...
from rdkit import Chem #rdkit is used for calculating molacular descriptors
